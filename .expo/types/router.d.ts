...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/components/Button` | `/components/CircleButton` | `/components/EmojiList` | `/components/EmojiPicker` | `/components/EmojiSticker` | `/components/IconButton` | `/components/ImageViewer`;
